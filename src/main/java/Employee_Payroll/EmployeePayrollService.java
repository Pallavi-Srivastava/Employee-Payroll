...
public class EmployeePayrollService {
	...
	public void addNewEmployeeToPayroll(String name, double salary, LocalDate start, String gender, String department, boolean active)
			throws EmployeePayrollException {
		employeePayrollList
				.add(employeePayrollDBService.addNewEmployeeToPayroll(name, salary, start, gender, department, active));
	}

	public void deleteEmployeeToPayroll(String name) throws EmployeePayrollException {
		this.employeePayrollList = this.employeePayrollDBService.deleteEmployeeToPayroll(name);
	}
